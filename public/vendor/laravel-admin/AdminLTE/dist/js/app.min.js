...
function _init() {
    ...
    $(".main-footer strong").html('Developed by <a class="company_link" href="https://artdock.studio/" target="_blank">ArtDock</a>  © 2020')
    $.AdminLTE.layout = {
        activate: function () {
            var a = this;
...
// $('body').on('click', '.phones-add', function () {
//     var tpl =   '<tr>\n' +
//         '        <td>\n' +
//         '           <div class="form-group ">\n' +
//     '                            <div class="col-sm-12">\n' +
//     '                                <input name="phones[values][]" value="" class="form-control"></div>\n' +
//     '                        </div>\n' +
//         '        </td>\n' +
//         '        <td class="form-group">\n' +
//         '                        <div class="phones-remove btn btn-warning btn-sm pull-right">\n' +
//         '                            <i class="fa fa-trash">&nbsp;</i>Удалить\n' +
//         '                        </div>\n' +
//         '        </td>\n' +
//         '    </tr>'
//
//     $('tbody.list-phones-table').append(tpl);
// });
